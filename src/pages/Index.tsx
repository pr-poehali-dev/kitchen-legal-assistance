...
Мы составим претензию, организуем экспертизу и взыщем компенсацию. Звоните: **8 (923) 609-55-02**`
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between">
            <button onClick={scrollToTop} className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <div>
                ...
                <div className="text-xs text-white/80 font-medium whitespace-nowrap tracking-[0.1em]">Ваш юрист по мебельным спорам</div>
              </div>
            </button>
            ...
            {[
              {
                ...
                description: "Звоните или пишите в Max мессенджер. Изучаем ваш договор, фотографии, документы. Рассчитываем неустойку и объясняем перспективы.",
            ...
            <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 max-w-3xl mx-auto">
              <CardContent className="pt-6">
                ...
                <p className="text-lg italic mb-4">
                  "Думали, что никогда не вернём свои деньги. Спасибо команде «Вернём кухню» — получили не только предоплату, 
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <Card className="bg-white/15 backdrop-blur-sm border-white/30 hover:bg-white/20 transition-all hover:scale-105">
                <CardContent className="pt-6 space-y-3 text-center">
                  ...
                  <a href="tel:89236095502" className="block text-2xl font-bold hover:text-secondary transition-colors text-white">
                    8 (923) 609-55-02
                  </a>
              ...
              <Card className="bg-white/15 backdrop-blur-sm border-white/30 hover:bg-white/20 transition-all hover:scale-105">
                <CardContent className="pt-6 space-y-3 text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center mx-auto shadow-lg">
                    <Icon name="MessageCircle" className="text-white" size={32} />
                  </div>
                  <h3 className="text-xl font-bold text-white">Max мессенджер</h3>
                  <p className="text-white/80">Быстрый ответ в мессенджере</p>
                  <Button onClick={handleMaxClick} className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white w-full">
                    Написать
                  </Button>
                </CardContent>
              </Card>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-24 right-6 w-10 h-10 bg-primary/70 hover:bg-primary/90 text-white rounded-full shadow-lg flex items-center justify-center z-50 transition-all hover:scale-110 animate-fade-in backdrop-blur-sm"
          aria-label="Наверх"
        >
